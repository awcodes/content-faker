...
it('includes scalar data as data attributes on filament blocks', function () {
    expect(RichEditorFaker::make()->filamentBlock('hero', ['variant' => 'centered'])->render())
        ->toContain('data-variant="centered"');
});

it('generates multiple filament blocks', function () {
...
it('generates a custom placeholder', function () {
...
it('inherits html methods', function () {
